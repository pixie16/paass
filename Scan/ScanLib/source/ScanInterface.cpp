...
ScanInterface::ScanInterface(Unpacker *core_/*=NULL*/) {
    ...
    baseOpts.push_back(optionExt("batch", no_argument, NULL, 'b', "",
                                 "Run in batch mode (i.e. with no command line)"));
    baseOpts.push_back(optionExt("config", required_argument, NULL, 'c',
                                 "<path>", "Specify configuration file to "
                                         "use for scan"));
    baseOpts.push_back(optionExt("counts", no_argument, NULL, 0, "",
                                 "Write all recorded channel counts to a file"));
    baseOpts.push_back(optionExt("debug", no_argument, NULL, 0, "",
                                 "Enable readout debug mode"));
    baseOpts.push_back(optionExt("dry-run", no_argument, NULL, 0, "",
    ...
    baseOpts.push_back(optionExt("help", no_argument, NULL, 'h', "",
    ...
    baseOpts.push_back(optionExt("quiet", no_argument, NULL, 'q', "",
                                 "Toggle off verbosity flag"));
    baseOpts.push_back(optionExt("shm", no_argument, NULL, 's', "",
                                 "Enable shared memory readout"));
    baseOpts.push_back(optionExt("version", no_argument, NULL, 'v', "",
