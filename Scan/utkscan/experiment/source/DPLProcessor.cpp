...
bool DPLProcessor::Process(RawEvent &event) {
	...
	for(vector<ChanEvent*>::const_iterator itA = tvandleEvents.begin();
	    ...
	    if(tvandle.GetIsValid() && labr3.GetIsValid()) {
