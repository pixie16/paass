...
namespace dammIds {
    ...
    namespace diagnostic {
        Plots histo(1, 1999, PlotsRegister::R());
        /*
    namespace misc {
...
// in pixie_std.cpp
    ...
    */
    ...
    namespace mcp {	
        Plots histo(2000, 10, PlotsRegister::R()); 
    /** 
    ...
    **/
    ...
    namespace scint {
      Plots histo(2100, 100, PlotsRegister::R()); 
        /*
        namespace neutr {
            namespace betaGated {
    ...
    // in GeProcessor.cpp
    namespace ge {
        Plots histo(2500, 500, PlotsRegister::R()); 
        /*
        // clovers
    ...
    namespace logic {
        Plots histo(3000, 80, PlotsRegister::R()); 
        /*
    ...
    namespace triggerlogic {
      Plots histo(3080, 20, PlotsRegister::R()); 
      /*
    ...
    namespace vandle{ //in VandleProcessor.cpp
        Plots histo(3100, 900, PlotsRegister::R()); 
        /*
    ...
    namespace waveformanalyzer{
        Plots histo(4000, 100, PlotsRegister::R()); 
    } // waveformanalyzer namespace

    // in SsdProcessor.cpp
    namespace ssd {
        Plots histo(4100, 100, PlotsRegister::R()); 
        /*
    ...
    namespace implantSsd {
        Plots histo(4200, 100, PlotsRegister::R()); 
    ...
    // in MtcProcessor.cpp
    namespace mtc {
        Plots histo(4500, 100, PlotsRegister::R()); 
        /*
    ...
    namespace pulserprocessor{ //in PulserProcessor.cpp 
        Plots histo(5000, 100, PlotsRegister::R()); 
        /*
    ...
    namespace correlator {
        Plots histo(6000, 100, PlotsRegister::R()); 
        /*
    ...
    // in dssd_sub.cpp
    namespace dssd {
        Plots histo(7000, 500, PlotsRegister::R()); 
        /*
    ...
    namespace trace {
// in trace.cpp
        Plots histo(7500, 200, PlotsRegister::R()); 
        /*
