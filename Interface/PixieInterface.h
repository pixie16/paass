...
class PixieInterface
{
 public:
  ...
  bool WriteSglModPar(char *name, word_t val, int mod);
  bool ReadSglModPar(char *name, word_t *pval, int mod);
  void PrintSglModPar(char *name, int mod);
  bool WriteSglChanPar(char *name, double val, int mod, int chan);
  bool ReadSglChanPar(char *name, double *pval, int mod, int chan);
  void PrintSglChanPar(char *name, int mod, int chan);
  bool SaveDSPParameters(char *fn = NULL);
