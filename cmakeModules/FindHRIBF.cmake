...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(HRIBF DEFAULT_MSG UPAK_LIBRARY_DIR ACQ2_LIBRARY_DIR)
if (HRIBF_FOUND)
    set (HRIBF_LIBRARIES ${UPAK_LIBRARY_DIR}/scanorlib.a ${UPAK_LIBRARY_DIR}/orphlib.a ${ACQ2_LIBRARY_DIR}/acqlib.a ${ACQ2_LIBRARY_DIR}/ipclib.a)
endif()
