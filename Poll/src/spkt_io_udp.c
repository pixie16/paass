...
*    
*    02/01/07   MTD         Function socket_poll was added  
*****************************************************************************/
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
...
{ 
  ...
  if(!mode) 
    {  FD_ZERO(&readfds);
     ...
     printf("socket_poll: Wrong argument. Should be 1 or 0\n"); 
     return -20;
}
...
int spkt_open(const char *node, int proto)
{
