...
namespace dammIds {
    ...
    namespace ge {
        ...
        */
        ...
        const int D_NONCYCGATEDENERGY = 400; //!<Same as D_ENERGY but
//!< without the cycling requirement, Useful for Cf and other tests
        ...
        namespace betaGated {
            ...
            const int DD_ADD_ENERGY__TIMEX = 180;//!< Beta Gated Addback Energy vs. Time
             ...
             const int D_NONCYCGATEDENERGY = 410; //!<Same as D_ENERGY but
//!< without the cycling requirement, Useful for Cf and other tests
        }
