...
namespace dammIds {
    namespace vandle {
        ...
        const int DD_TOFVSSTARTQDCSUM    = 9;//!< ToF vs. Start QDC
        ...
        const int DD_NONCORTOFVSQDC    = 13;//!< Non gated qdc vs tof
...
//        "Bar vs CorTOF - Gamma Veto");
        DeclareHistogram2D(DD_NONCORTOFVSQDC+MED_OFFSET,SC,SD,"non gated QDC "
                "vs tof ");
    }
