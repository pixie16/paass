...
public:
    ...
    * \return the requested value */
    ...
    std::vector<double> GetWaveform() {
        return std::vector<double>(baselineSubTrace_.begin() +
                                   waveformRange_.first,
                                   baselineSubTrace_.begin() +
    ...
    * \param [in] offset : the offset for the trace*/
    ...
    ///@brief sets the baseline subtracted trace for use.
...
private:
    ...
    std::vector<double> baselineSubTrace_; ///!< Baseline subtracted trace
